  ...
  return (
    <section className="h-svh flex justify-center items-center flex-col relative bg-gradient-to-r from-fuchsia-300 bg-blend-multiply">
      ...
      <div className="flex justify-center items-center w-full flex-col">
        ...
        <p className="mt-3 md:text-2xl text-white">24 años Proyectando Bolivia al mundo</p>
      </div>
      <div className='absolute w-full h-screen -z-10'>
        <Image src='/img/dc-2024.jpg' objectFit="cover" layout="fill" alt='Danzacruz 2024' />
      </div>
      <div className="uppercase md:text-xl mt-10 text-fuchsia-900">Del 8 al 10 de noviembre</div>
