          ...
          <div>
            ...
            <div>
              <a 
                ...
                target="_blank" 
                className="hover:text-fuchsia-600 transition-all">Facebook</a>
              </div>
            </div>
            <div>
              <h4 className="text-2xl font-semibold">Contacto</h4>
              <div className="flex flex-col">
                <a href="http://wa.me/59175020012" className="hover:text-fuchsia-600 transition-all">
                 75020012</a>
                <a href="http://wa.me/59175553576" className="hover:text-fuchsia-600 transition-all">75553576</a>
              </div>
            </div>
        </div>
      </div>
